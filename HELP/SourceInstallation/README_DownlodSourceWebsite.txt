...
12.) Create a C++ project:
	...
	- Give it a "Project name" of "MFSimSSA" (ignore warning, this will cause it to automatically import the existing files)
	- For "Project type", select "Executable->Empty Project"
		- NOTE: You may need to UNCHECK "Show project types and toolchains only if they are suppored on the platform" to see these options
...
13.) Add references for timer library:
	...
	- Right click on the "MFSimSSA" C++ project in the Project Explorer

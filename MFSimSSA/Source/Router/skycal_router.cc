...
: Router(NULL), Scheduler(), cells(), executionTable(), growthFactors(), numDroplets(0), availableArea(0),
...
: Router(arch), Scheduler(), cells(), executionTable(), growthFactors(), numDroplets(0), availableArea(0),

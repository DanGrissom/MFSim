...
// major revisions due in November 2014.
///////////////////////////////////////////////////////////////////////////
void Test::ZachVlsiJournal2014Experiments()
{
	// Don't touch these
	int maxDropsPerStorageMod = 2;
	int minCellsBetweenIrMods = 1;

	// These are the 10 different assays. Run one at a time (i.e., only one should be commented at any given time
	// For the assays that start with "Assays/B5", these are new assays from Chris Curtis that you won't have.
	// The assay files and corresponding DMFBArch files can be found in the folders indicated in the code for
	// that line.
	//Synthesis::Schedule("Assays/B1/MixSplit/PCR.txt", "DmfbArchs/IndividuallyAddressable/B1/Arch_15_19_B1.txt", "Output/1_SCHED_to_PLACE.txt", FD_LIST_S, GRISSOM_FIX_0_RA, CLIQUE_PM, maxDropsPerStorageMod);
	//Synthesis::Schedule("Assays/B2/InVitro_Ex5_4s_4r.txt", "DmfbArchs/IndividuallyAddressable/B2/Arch_15_19_B2.txt", "Output/1_SCHED_to_PLACE.txt", FD_LIST_S, GRISSOM_FIX_0_RA, CLIQUE_PM, maxDropsPerStorageMod);
	//Synthesis::Schedule("Assays/B3/MixSplit/Protein.txt", "DmfbArchs/IndividuallyAddressable/B3and4/Arch_15_19_B3.txt", "Output/1_SCHED_to_PLACE.txt", FD_LIST_S, GRISSOM_FIX_0_RA, SWITCH_PM, maxDropsPerStorageMod);
	//Synthesis::Schedule("Assays/B4/MixSplit/ProteinSplit_05_Eq.txt", "DmfbArchs/IndividuallyAddressable/B3and4/Arch_15_19_B3.txt", "Output/1_SCHED_to_PLACE.txt", PATH_S, GRISSOM_FIX_0_RA, CLIQUE_PM, maxDropsPerStorageMod);
	//Synthesis::Schedule("Assays/B5/CoDos5React2_45_23_67_93.txt", "DmfbArchs/IndividuallyAddressable/B5/Arch_15_19_B5.txt", "Output/1_SCHED_to_PLACE.txt", FD_LIST_S, GRISSOM_FIX_0_RA, CLIQUE_PM, maxDropsPerStorageMod);
	//Synthesis::Schedule("Assays/B5/Gorma23_256.txt", "DmfbArchs/IndividuallyAddressable/B5/Arch_15_19_B5.txt", "Output/1_SCHED_to_PLACE.txt", FD_LIST_S, GRISSOM_FIX_0_RA, CLIQUE_PM, maxDropsPerStorageMod);
	//Synthesis::Schedule("Assays/B5/griffith.txt", "DmfbArchs/IndividuallyAddressable/B5/Arch_15_19_B5.txt", "Output/1_SCHED_to_PLACE.txt", FD_LIST_S, GRISSOM_FIX_0_RA, CLIQUE_PM, maxDropsPerStorageMod);
	//Synthesis::Schedule("Assays/B5/Remia191_1024.txt", "DmfbArchs/IndividuallyAddressable/B5/Arch_15_19_B5.txt", "Output/1_SCHED_to_PLACE.txt", FD_LIST_S, GRISSOM_FIX_0_RA, CLIQUE_PM, maxDropsPerStorageMod);
	//Synthesis::Schedule("Assays/B5/Remia641_1024.txt", "DmfbArchs/IndividuallyAddressable/B5/Arch_15_19_B5.txt", "Output/1_SCHED_to_PLACE.txt", FD_LIST_S, GRISSOM_FIX_0_RA, CLIQUE_PM, maxDropsPerStorageMod);
	Synthesis::Schedule("Assays/B5/Remia850_1024.txt", "DmfbArchs/IndividuallyAddressable/B5/Arch_15_19_B5.txt", "Output/1_SCHED_to_PLACE.txt", FD_LIST_S, GRISSOM_FIX_0_RA, SWITCH_PM, maxDropsPerStorageMod);

	////////////////////////////////////////////////////////////
	// First, choose between KAMER and Virtual Topology placement:
...
void Test::ZachPlaceAndRoute()
{
	...
	////////////////////////////////////////////////////////////
	// Next, choose droplet router type:
	//RouterType rt = ROY_MAZE_R;
	RouterType rt = CHO_R;

	////////////////////////////////////////////////////////////
	// Next, choose route compaction type
	//CompactionType ct = BEG_COMP; // If using beginning-compaction, use this...
	CompactionType ct = CHO_COMP; // If using cho-compaction, use this:
	//CompactionType ct = DYN_COMP; //...else, if using dynamic compaction, use this line instead


	Synthesis::Place("Output/1_SCHED_to_PLACE.txt", "Output/2_PLACE_to_ROUTE.txt", pt, minCellsBetweenIrMods);
	Synthesis::Route("Output/2_PLACE_to_ROUTE.txt", rt, false, ct, pet, SIM_EX);
	//Synthesis::WireRoute("Output/3_ROUTE_to_SIM.txt", ENHANCED_FPPC_WR, 3, 3); // Call wire-routing here if you'd like
}

void Test::VlsiJournal2014Experiments()
{
	int maxDropsPerStorageMod = 2;
	int minCellsBetweenIrMods = 1;
	...
	//Synthesis::Schedule("Assays/B1/MixSplit/PCR.txt", "DmfbArchs/IndividuallyAddressable/B1/Arch_15_19_B1.txt", "Output/1_SCHED_to_PLACE.txt", PATH_S, GRISSOM_FIX_0_RA, INDIVADDR_PM, maxDropsPerStorageMod);
	//Synthesis::Schedule("Assays/B1/MixSplit/PCR.txt", "DmfbArchs/IndividuallyAddressable/B1/Arch_15_19_B1.txt", "Output/1_SCHED_to_PLACE.txt", GENET_S, GRISSOM_FIX_0_RA, INDIVADDR_PM, maxDropsPerStorageMod);
	//Synthesis::Schedule("Assays/B1/MixSplit/PCR.txt", "DmfbArchs/IndividuallyAddressable/B1/Arch_15_19_B1.txt", "Output/1_SCHED_to_PLACE.txt", RICKETT_S, GRISSOM_FIX_0_RA, INDIVADDR_PM, maxDropsPerStorageMod);
	//Synthesis::Schedule("Assays/B1/MixSplit/PCR.txt", "DmfbArchs/IndividuallyAddressable/B1/Arch_15_19_B1.txt", "Output/1_SCHED_to_PLACE.txt", FD_LIST_S, GRISSOM_FIX_0_RA, INDIVADDR_PM, maxDropsPerStorageMod);
	//Synthesis::Schedule("Assays/B1/MixSplit/PCR.txt", "DmfbArchs/FPPC/Enhanced_TCAD/Arch_FPPC2_B1.txt", "Output/1_SCHED_to_PLACE.txt", FPPC_S, PC_INHERENT_RA, ENHANCED_FPPC_ROUTE_OPT_PM, 1);
	//Synthesis::Schedule("Assays/B1/MixSplit/PCR.txt", "DmfbArchs/FPPC/Enhanced_TCAD/Arch_FPPC2_B1.txt", "Output/1_SCHED_to_PLACE.txt", FPPC_PATH_S, PC_INHERENT_RA, ENHANCED_FPPC_ROUTE_OPT_PM, 1);


	// InVitro 5 Scheduling
	cout << "\n\n\n\n*********InVitro5*********" << endl;
	...
	//Synthesis::Schedule("Assays/B2/InVitro_Ex5_4s_4r.txt", "DmfbArchs/IndividuallyAddressable/B2/Arch_15_19_B2.txt", "Output/1_SCHED_to_PLACE.txt", PATH_S, GRISSOM_FIX_0_RA, INDIVADDR_PM, maxDropsPerStorageMod);
	//Synthesis::Schedule("Assays/B2/InVitro_Ex5_4s_4r.txt", "DmfbArchs/IndividuallyAddressable/B2/Arch_15_19_B2.txt", "Output/1_SCHED_to_PLACE.txt", GENET_S, GRISSOM_FIX_0_RA, INDIVADDR_PM, maxDropsPerStorageMod);
	//Synthesis::Schedule("Assays/B2/InVitro_Ex5_4s_4r.txt", "DmfbArchs/IndividuallyAddressable/B2/Arch_15_19_B2.txt", "Output/1_SCHED_to_PLACE.txt", RICKETT_S, GRISSOM_FIX_0_RA, INDIVADDR_PM, maxDropsPerStorageMod);
	//Synthesis::Schedule("Assays/B2/InVitro_Ex5_4s_4r.txt", "DmfbArchs/IndividuallyAddressable/B2/Arch_15_19_B2.txt", "Output/1_SCHED_to_PLACE.txt", FD_LIST_S, GRISSOM_FIX_0_RA, INDIVADDR_PM, maxDropsPerStorageMod);
	//Synthesis::Schedule("Assays/B2/InVitro_Ex5_4s_4r.txt", "DmfbArchs/FPPC/Enhanced_TCAD/Arch_FPPC2_B2.txt", "Output/1_SCHED_to_PLACE.txt", FPPC_S, PC_INHERENT_RA, ENHANCED_FPPC_ROUTE_OPT_PM, 1);
	//Synthesis::Schedule("Assays/B2/InVitro_Ex5_4s_4r.txt", "DmfbArchs/FPPC/Enhanced_TCAD/Arch_FPPC2_B2.txt", "Output/1_SCHED_to_PLACE.txt", FPPC_PATH_S, PC_INHERENT_RA, ENHANCED_FPPC_ROUTE_OPT_PM, 1);


	// Protein (3) Scheduling
	cout << "\n\n\n\n*********Protein*********" << endl;
	//Synthesis::Schedule("Assays/B3/MixSplit/Protein.txt", "DmfbArchs/IndividuallyAddressable/B3and4/Arch_15_19_B3.txt", "Output/1_SCHED_to_PLACE.txt", LIST_S, GRISSOM_FIX_0_RA, INDIVADDR_PM, maxDropsPerStorageMod);
	//Synthesis::Schedule("Assays/B3/MixSplit/Protein.txt", "DmfbArchs/IndividuallyAddressable/B3and4/Arch_15_19_B3.txt", "Output/1_SCHED_to_PLACE.txt", PATH_S, GRISSOM_FIX_0_RA, INDIVADDR_PM, maxDropsPerStorageMod);
	//Synthesis::Schedule("Assays/B3/MixSplit/Protein.txt", "DmfbArchs/IndividuallyAddressable/B3and4/Arch_15_19_B3.txt", "Output/1_SCHED_to_PLACE.txt", GENET_S, GRISSOM_FIX_0_RA, INDIVADDR_PM, maxDropsPerStorageMod);
	//Synthesis::Schedule("Assays/B3/MixSplit/Protein.txt", "DmfbArchs/IndividuallyAddressable/B3and4/Arch_15_19_B3.txt", "Output/1_SCHED_to_PLACE.txt", RICKETT_S, GRISSOM_FIX_0_RA, INDIVADDR_PM, maxDropsPerStorageMod);
	//Synthesis::Schedule("Assays/B3/MixSplit/Protein.txt", "DmfbArchs/IndividuallyAddressable/B3and4/Arch_15_19_B3.txt", "Output/1_SCHED_to_PLACE.txt", FD_LIST_S, GRISSOM_FIX_0_RA, INDIVADDR_PM, maxDropsPerStorageMod);
	//Synthesis::Schedule("Assays/B3/MixSplit/Protein.txt", "DmfbArchs/FPPC/Enhanced_TCAD/Arch_FPPC2_B3.txt", "Output/1_SCHED_to_PLACE.txt", FPPC_S, PC_INHERENT_RA, ENHANCED_FPPC_ROUTE_OPT_PM, 1);
	//Synthesis::Schedule("Assays/B3/MixSplit/Protein.txt", "DmfbArchs/FPPC/Enhanced_TCAD/Arch_FPPC2_B3.txt", "Output/1_SCHED_to_PLACE.txt", FPPC_PATH_S, PC_INHERENT_RA, ENHANCED_FPPC_ROUTE_OPT_PM, 1);


	// ProteinSplit5 (5 splits)  Scheduling
	//cout << "\n\n\n\n*********Protein*********" << endl;
	//Synthesis::Schedule("Assays/B4/MixSplit/ProteinSplit_05_Eq.txt", "DmfbArchs/IndividuallyAddressable/B3and4/Arch_15_19_B3.txt", "Output/1_SCHED_to_PLACE.txt", LIST_S, GRISSOM_FIX_0_RA, INDIVADDR_PM, maxDropsPerStorageMod);
	//Synthesis::Schedule("Assays/B4/MixSplit/ProteinSplit_05_Eq.txt", "DmfbArchs/IndividuallyAddressable/B3and4/Arch_15_19_B3.txt", "Output/1_SCHED_to_PLACE.txt", PATH_S, GRISSOM_FIX_0_RA, INDIVADDR_PM, maxDropsPerStorageMod);
	//Synthesis::Schedule("Assays/B4/MixSplit/ProteinSplit_05_Eq.txt", "DmfbArchs/IndividuallyAddressable/B3and4/Arch_15_19_B3.txt", "Output/1_SCHED_to_PLACE.txt", GENET_S, GRISSOM_FIX_0_RA, INDIVADDR_PM, maxDropsPerStorageMod);
	//Synthesis::Schedule("Assays/B4/MixSplit/ProteinSplit_05_Eq.txt", "DmfbArchs/IndividuallyAddressable/B3and4/Arch_15_19_B3.txt", "Output/1_SCHED_to_PLACE.txt", RICKETT_S, GRISSOM_FIX_0_RA, INDIVADDR_PM, maxDropsPerStorageMod);
	//Synthesis::Schedule("Assays/B4/MixSplit/ProteinSplit_05_Eq.txt", "DmfbArchs/IndividuallyAddressable/B3and4/Arch_15_19_B3.txt", "Output/1_SCHED_to_PLACE.txt", FD_LIST_S, GRISSOM_FIX_0_RA, INDIVADDR_PM, maxDropsPerStorageMod);
	//Synthesis::Schedule("Assays/B4/MixSplit/ProteinSplit_01_Eq.txt", "DmfbArchs/FPPC/Enhanced_TCAD/Arch_FPPC2_B3.txt", "Output/1_SCHED_to_PLACE.txt", FPPC_PATH_S, PC_INHERENT_RA, ENHANCED_FPPC_ROUTE_OPT_PM, 1);
	//Synthesis::Schedule("Assays/B4/MixSplit/ProteinSplit_05_Eq.txt", "DmfbArchs/FPPC/Enhanced_TCAD/Arch_FPPC2_B3.txt", "Output/1_SCHED_to_PLACE.txt", FPPC_S, PC_INHERENT_RA, ENHANCED_FPPC_ROUTE_OPT_PM, 1);


	// ProteinSplit5 (5 splits)  Scheduling
	string b5Name = "Assays/B5/CoDos5React2_45_23_67_93.txt";
	//string b5Name = "Assays/B5/Gorma23_256.txt";
	//string b5Name = "Assays/B5/griffith.txt";
	//string b5Name = "Assays/B5/Remia191_1024.txt";
	//string b5Name = "Assays/B5/Remia641_1024.txt";
	//string b5Name = "Assays/B5/Remia850_1024.txt";
	cout << "\n\n\n\n*********" << b5Name << "*********" << endl;
	//Synthesis::Schedule(b5Name, "DmfbArchs/IndividuallyAddressable/B5/Arch_15_19_B5.txt", "Output/1_SCHED_to_PLACE.txt", LIST_S, GRISSOM_FIX_0_RA, INDIVADDR_PM, maxDropsPerStorageMod);
	//Synthesis::Schedule(b5Name, "DmfbArchs/IndividuallyAddressable/B5/Arch_15_19_B5.txt", "Output/1_SCHED_to_PLACE.txt", PATH_S, GRISSOM_FIX_0_RA, INDIVADDR_PM, maxDropsPerStorageMod);
	//Synthesis::Schedule(b5Name, "DmfbArchs/IndividuallyAddressable/B5/Arch_15_19_B5.txt", "Output/1_SCHED_to_PLACE.txt", GENET_S, GRISSOM_FIX_0_RA, INDIVADDR_PM, maxDropsPerStorageMod);
	//Synthesis::Schedule(b5Name, "DmfbArchs/IndividuallyAddressable/B5/Arch_15_19_B5.txt", "Output/1_SCHED_to_PLACE.txt", RICKETT_S, GRISSOM_FIX_0_RA, INDIVADDR_PM, maxDropsPerStorageMod);
	//Synthesis::Schedule(b5Name, "DmfbArchs/IndividuallyAddressable/B5/Arch_15_19_B5.txt", "Output/1_SCHED_to_PLACE.txt", FD_LIST_S, GRISSOM_FIX_0_RA, INDIVADDR_PM, maxDropsPerStorageMod);
	//Synthesis::Schedule(b5Name, "DmfbArchs/FPPC/Enhanced_TCAD/Arch_FPPC2_B5.txt", "Output/1_SCHED_to_PLACE.txt", FPPC_S, PC_INHERENT_RA, ENHANCED_FPPC_ROUTE_OPT_PM, 1);
	//Synthesis::Schedule(b5Name, "DmfbArchs/FPPC/Enhanced_TCAD/Arch_FPPC2_B5.txt", "Output/1_SCHED_to_PLACE.txt", FPPC_PATH_S, PC_INHERENT_RA, ENHANCED_FPPC_ROUTE_OPT_PM, 1);
	...
	Synthesis::Place("Output/1_SCHED_to_PLACE.txt", "Output/2_PLACE_to_ROUTE.txt", KAMER_LL_P, minCellsBetweenIrMods);
	Synthesis::Route("Output/2_PLACE_to_ROUTE.txt", ROY_MAZE_R, false, DYN_COMP, FREE_PE, SIM_EX);
...
DAG *Test::ScheduleAndReturnDag(string inputDagFile, string inputArchFile, string outputFile, SchedulerType st, ResourceAllocationType rat, PinMapType pmt, int maxStorageDropsPerMod)
{
	...
	CompatChk::PreScheduleChk(scheduler, arch, schedDag, false);
...
///////////////////////////////////////////////////////////////////////////
// Contains the main sandbox code in main.cc before that file was cleaned
// up for the 2015 release.
///////////////////////////////////////////////////////////////////////////
void Test::MainSandboxCode()
{
	...
	//Test::VlsiJournal2014Experiments();
	//Test::ZachVlsiJournal2014Experiments();
	//exit(0);
	...
	////////////////////////////////////////////////////////////////////////////
	Synthesis::EntireFlow("Assays/B5/Remia850_1024.txt", "DmfbArchs/IndividuallyAddressable/B5/Arch_15_19_B5.txt", LIST_S, GRISSOM_LE_B, ROY_MAZE_R, false, GRISSOM_FIX_0_RA, SWITCH_PM, PIN_MAPPER_INHERENT_WR, BEG_COMP, FIXED_PE, ALL_EX, maxDropsPerStorageMod, minCellsBetweenIrMods, numHorizTracks, numVertTracks);
	cout << "Exiting..." << endl;
	exit(0);
	...
	////////////////////////////////////////////////////////////////////////////
	//Synthesis::EntireFlow("Assays/B1/MixSplit/PCR.txt", "DmfbArchs/IndividuallyAddressable/B1/Arch_15_19_B1.txt", ROUTING_BASED_SYNTHESIS_S, ROUTING_BASED_SYNTHESIS_P, ROUTING_BASED_SYNTHESIS_R, GRISSOM_FIX_1_RA, INDIVADDR_PM, PATH_FINDER_WR, INHERENT_COMP, FIXED_PE, ALL_EX, maxDropsPerStorageMod, minCellsBetweenIrMods, numHorizTracks, numVertTracks);
	//Synthesis::EntireFlow("Assays/B2/InVitro_Ex1_2s_2r.txt", "DmfbArchs/IndividuallyAddressable/B2/Arch_15_19_B2.txt", ROUTING_BASED_SYNTHESIS_S, ROUTING_BASED_SYNTHESIS_P, ROUTING_BASED_SYNTHESIS_R, GRISSOM_FIX_1_RA, INDIVADDR_PM, NONE_WR, INHERENT_COMP, FIXED_PE, ALL_EX, maxDropsPerStorageMod, minCellsBetweenIrMods, numHorizTracks, numVertTracks);
	//Synthesis::EntireFlow("Assays/B2/InVitro_Ex5_4s_4r.txt", "DmfbArchs/IndividuallyAddressable/B2/Arch_15_19_B2.txt", ROUTING_BASED_SYNTHESIS_S, ROUTING_BASED_SYNTHESIS_P, ROUTING_BASED_SYNTHESIS_R, GRISSOM_FIX_1_RA, INDIVADDR_PM, NONE_WR, INHERENT_COMP, FIXED_PE, ALL_EX, maxDropsPerStorageMod, minCellsBetweenIrMods, numHorizTracks, numVertTracks);
	//Synthesis::EntireFlow("Assays/B2/InVitro_Ex5_4s_4r.txt", "DmfbArchs/IndividuallyAddressable/B2/Arch_15_19_B2.txt", ROUTING_BASED_SYNTHESIS_S, ROUTING_BASED_SYNTHESIS_P, ROUTING_BASED_SYNTHESIS_R, GRISSOM_FIX_1_RA, INDIVADDR_PM, NONE_WR, INHERENT_COMP, FIXED_PE, ALL_EX, maxDropsPerStorageMod, minCellsBetweenIrMods, numHorizTracks, numVertTracks);
	//Synthesis::EntireFlow("Assays/B3/MixSplit/Protein.txt", "DmfbArchs/IndividuallyAddressable/B3and4/Arch_15_19_B3.txt", ROUTING_BASED_SYNTHESIS_S, ROUTING_BASED_SYNTHESIS_P, ROUTING_BASED_SYNTHESIS_R, GRISSOM_FIX_1_RA, INDIVADDR_PM, NONE_WR, INHERENT_COMP, FIXED_PE, ALL_EX, maxDropsPerStorageMod, minCellsBetweenIrMods, numHorizTracks, numVertTracks);
	//Synthesis::EntireFlow("Assays/B4/MixSplit/ProteinSplit_05_Eq.txt", "DmfbArchs/IndividuallyAddressable/B3and4/Arch_15_19_B3.txt", ROUTING_BASED_SYNTHESIS_S, ROUTING_BASED_SYNTHESIS_P, ROUTING_BASED_SYNTHESIS_R, GRISSOM_FIX_1_RA, INDIVADDR_PM, NONE_WR, INHERENT_COMP, FIXED_PE, ALL_EX, maxDropsPerStorageMod, minCellsBetweenIrMods, numHorizTracks, numVertTracks);
	...
	//Synthesis::Schedule("Assays/B2/InVitro_Ex5_4s_4r.txt", "DmfbArchs/IndividuallyAddressable/B2/Arch_15_19_B2.txt", "Output/1_SCHED_to_PLACE.txt", LIST_S, GRISSOM_FIX_0_RA, INDIVADDR_PM, maxDropsPerStorageMod);
	//Synthesis::Schedule("Assays/B4/MixSplit/ProteinSplit_05_Eq.txt", "DmfbArchs/IndividuallyAddressable/B3and4/Arch_15_19_B3.txt", "Output/1_SCHED_to_PLACE.txt", LIST_S, GRISSOM_FIX_1_RA, INDIVADDR_PM, maxDropsPerStorageMod);
